...
namespace SMB.BuilderBLLSCodeComm
{
    /// <summary>
    /// 业务层代码组件
    /// </summary>
    public class BuilderBLL : LTP.IBuilder.IBuilderBLL
    {
        #region 私有变量
        protected string _key = "RecID";//默认第一个主键字段		
        ...
        /// 是否有事务
        /// </summary>
        public bool WithTran
        {
            set { _withtran = value; }
            get { return _withtran; }
        }
        //*
        #endregion		
        ...
        {            
            ...
            strclass.AppendLine("//////////////////////////////////////////////////////////////////////////");
            strclass.AppendLine("// FileName:"+ModelName);
            strclass.AppendLine("// CreateBy:");
            strclass.AppendLine("// CreateDate:"+DateTime.Now.ToShortDateString());
            strclass.AppendLine("// Description:");
            strclass.AppendLine("//		Class "+ModelName+",table "+new TableInfo().TabName);
            strclass.AppendLine("//      ");
            strclass.AppendLine("// Modify Log:");
            strclass.AppendLine("//	");
            strclass.AppendLine("// Copyright:");
            strclass.AppendLine("/////////////////////////////////////////////////////////////////////////");           
            ...
            if (GetModelByCache)
            {
                strclass.AppendLine("using Auto.Components;");
            }
            strclass.AppendLine("using Model = " + Modelpath + ";");
            ...
            if (WithTran)
            {
                strclass.AppendLine("using Auto.Data.DBUtility;  //Please Add Reference First");
            }
            strclass.AppendLine("namespace " + BLLpath );
            strclass.AppendLine("{" );
            strclass.AppendSpaceLine(1, "/// <summary>" );
            strclass.AppendSpaceLine(1, "/// BLL " + BLLName + " Description");
            strclass.AppendSpaceLine(1, "/// </summary>" );
            strclass.AppendSpaceLine(1, "public class " + BLLName);
            strclass.AppendSpaceLine(1, "{" );

            if (!string.IsNullOrEmpty(IClass) && WithTran) //开启事务  --20091227
            {
                strclass.AppendSpaceLine(2, "private readonly " + IClass + " dal=" + "DataAccess<"+IClass+">.CreateDALInstance(\""+DALName+"\");");
            }
            else if ((IClass != "") && (IClass != null))
            {
            ...
            #region  方法代码
            #region --New--
            strclass.AppendSpaceLine(1,"#region --New--");
            strclass.AppendSpaceLine(1, "/// <summary>");
            strclass.AppendSpaceLine(1, "///  Constructed Function ");
            strclass.AppendSpaceLine(1, "/// </summary>");
            ...
            strclass.AppendSpaceLine(1, "#endregion --New--");
            #endregion --New--

            #region --Operate--
            strclass.AppendSpaceLine(1, "#region --Operate--");
            if (Exists)
            {
            ...
            strclass.AppendSpaceLine(1, "#endregion --Operate--");
            #endregion --Operate--

            #region --SQL--
            strclass.AppendSpaceLine(1, "#region --SQL--");
            if (Add)
            {
            ...
            strclass.AppendSpaceLine(1, "#endregion --SQL--");
            #endregion --SQL--

            #region --Get Data--
            strclass.AppendSpaceLine(1, "#region --Get Data--");
            if (List)
            {
            ...
            strclass.AppendSpaceLine(1, "#endregion --Get Data--");
            #endregion --Get Data--
        ...
        public string CreatBLLGetModel()
        {
            ...
            strclass.AppendSpaceLine(2, "///  Get Model ");
            strclass.AppendSpaceLine(2, "/// </summary>");
